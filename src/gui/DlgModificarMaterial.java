...
public class DlgModificarMaterial extends JDialog implements ActionListener {
	...
	public DlgModificarMaterial() {
		...
		btnModificar.setBounds(514, 197, 124, 47);
		...
		lblMaterialesModificados = new JLabel("MATERIALES MODIFICADOS:");
		lblMaterialesModificados.setBounds(10, 273, 175, 23);
		getContentPane().add(lblMaterialesModificados);
		
		cmbTipoMaterial = new JComboBox<String>();
		cmbTipoMaterial.setBounds(166, 60, 129, 22);
